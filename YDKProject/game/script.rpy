...
define h = Character('Sylvie', color="#c8ffc8")
define s = Character('사냐', color="#c8c8ff")
define m = Character('하d울', color="#c8c8ff")
define y = Character('용덕킴', color = "#c8c8ff")
define rabbit = Character('토끼', color = "#FF7E9D")
define jina = Character('진아', color = "#c8ffc8")
...
image rabbit = im.FactorScale("images/rabbit.png", 1)
image fukamori = "background/deepforest.jpg"
image myroom = "background/myroom.jpg"
image studyroom = im.FactorScale("images/studyroom.png", 4)
image jina_idle = im.FactorScale("images/jina_idle.png", 0.5)
...
label start:
    ...
    y "조용히 안하나!!" with hpunch
    
    s "저분은 용덕킴. 분명 내 3학년 담임을 맡았던 것 같다."
